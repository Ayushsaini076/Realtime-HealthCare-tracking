...
const page = () => {
  return (
    <div className=" bg-blue-50 h-screen overflow-auto w-[85vw]">
      ...
      <div className="flex justify-around pt-4">
        ...
        <div className="w-2/3 h-60">
          ...
          <img className="relative left-[4rem] bottom-[0.5rem] w-[80%] h-[100%]" src="/heading.png" alt="" />
        </div>
        <div className="w-[18rem] h-48 relative right-[4rem] top-[2.5rem]   bg-white rounded-[0.8rem] p-[1.5rem]">
      ...
      <div className="mt-[3rem] flex m-3 relative left-4 h-[47%] flex-between w-full ">
        <div className="w-[35rem] h-[100%] ml-[1rem] bg-white rounded-[0.4rem] p-[1rem] ">
          <div className="flex justify-between">
            <div>
        ...
        <div className="w-[35rem] h-[100%] relative left-[5rem] bg-white rounded-[0.4rem] p-[1rem]">
          <div className="flex justify-between">
            <div>
